...
if (!["history-retention", "terminal-memory", "tool-memory", "app-update", "chat-collaboration", "collaboration", "markdown-memory", "profiles", "mermaid", "composer-stack", "scrolling", "work-shell", "work-stream", "history", "rendering", "materials", "scaling", "interaction", "questions", "artifacts", "memory", "continuation", "sessions", "chat-fixes", "activity", "prompts", "integrations", "icon-swap"].includes(fixture)) throw new Error("Unknown rendering fixture")
