...
if (!["rendering", "materials", "scaling", "interaction", "questions", "artifacts", "memory", "continuation", "sessions", "chat-fixes"].includes(fixture)) throw new Error("Unknown rendering fixture")
