...
if (!["rendering", "materials", "scaling", "interaction", "questions", "artifacts", "memory", "continuation", "sessions"].includes(fixture)) throw new Error("Unknown rendering fixture")
