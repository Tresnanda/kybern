...
if (!["app-update", "chat-collaboration", "collaboration", "composer-stack", "scrolling", "work-shell", "work-stream", "history", "rendering", "materials", "scaling", "interaction", "questions", "artifacts", "memory", "continuation", "sessions", "chat-fixes", "activity", "prompts", "integrations"].includes(fixture)) throw new Error("Unknown rendering fixture")
