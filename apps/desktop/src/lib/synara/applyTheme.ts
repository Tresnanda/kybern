// Projects Synara's runtime theme tokens (color math from a seed), density,
// typography, and chat-width variables onto <html>, the way Synara's
// hooks/useTheme.ts does. Kybern keeps a single default pack per variant.
