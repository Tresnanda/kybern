...
import { ChevronDownIcon, ComposerSendArrowIcon, HandRaisedIcon, MessageCircleIcon, PaperclipIcon, PencilIcon, PlusIcon, RefreshCwIcon, PluginIcon,
  ShieldAccessIcon, ShieldCodeIcon, SkillCubeIcon, TerminalIcon, XIcon } from "@/lib/kit/icons"
...
const MODES: { mode: PermissionMode; label: string; description: string; icon: React.ReactNode }[] = [
  ...
  { mode: "auto", label: "Approve for me", description: "Only ask for actions detected as potentially unsafe", icon: <ShieldCodeIcon className="size-4" /> },
  { mode: "full-access", label: "Full access", description: "Unrestricted access to the internet and any file on your computer", icon: <ShieldAccessIcon className="size-4" /> },
]
