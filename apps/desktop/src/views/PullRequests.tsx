...
import { CheckIcon, FilterIcon, GitMergedSimpleIcon, GitPullRequestClosedIcon, GitPullRequestIcon, RefreshCwIcon } from "@/lib/kit/icons"
...
function stateGlyph(pr: PullRequest) {
  ...
  if (state === "MERGED") return <GitMergedSimpleIcon className="size-[1.125rem] text-[color:var(--color-status-merged,#a371f7)]" />
