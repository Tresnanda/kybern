...
import { XIcon } from "@/lib/synara/icons";
import { cn } from "@/lib/utils";
import { Button, dialogActionButtonClassName } from "@/components/synara/button";
import { ScrollArea } from "@/components/synara/scroll-area";
...
function DialogBackdrop({ className, ...props }: DialogPrimitive.Backdrop.Props) {
  return (
    <DialogPrimitive.Backdrop
      className={cn(
        "fixed inset-0 z-50 bg-black/60 transition-opacity duration-200 motion-reduce:transition-none data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
