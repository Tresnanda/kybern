...
// Purpose: Shared Synara file/folder glyph for composer, diff, and transcript rows.

import { FolderClosed, FolderOpen } from "@/components/synara/FolderClosed"
import { CentralIcon } from "@/lib/synara/central-icons"
import { getAttachmentIconName, getFileIconName } from "@/lib/synara/fileIcons"
