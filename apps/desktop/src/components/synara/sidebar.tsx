...
import { Separator } from "@/components/synara/separator";
import {
  Sheet,
  SheetDescription,
  SheetHeader,
  SheetPopup,
  SheetTitle,
} from "@/components/synara/sheet";
import { Skeleton } from "@/components/synara/skeleton";
import { Tooltip, TooltipPopup, TooltipTrigger } from "@/components/synara/tooltip";
import { useIsMobile } from "@/lib/synara/hooks";
import { getLocalStorageItem, setLocalStorageItem, Schema } from "@/lib/synara/hooks";
...
function SidebarRail({
  ...
  React.useEffect(() => {
    ...
    const storedWidth = getLocalStorageItem<number>(resolvedResizable.storageKey, Schema.Finite);
