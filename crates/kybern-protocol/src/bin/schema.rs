...
fn main() {
    ...
    add::<CollaborationGroup>(&mut types, "CollaborationGroup");
    add::<CollaborationAssignment>(&mut types, "CollaborationAssignment");
    add::<CollaborationMessage>(&mut types, "CollaborationMessage");
    add::<ContextEntry>(&mut types, "ContextEntry");
    ...
    method::<ThreadsSearch>(&mut methods);
    ...
    method::<CollaborationGroupsControl>(&mut methods);
    method::<CollaborationMembersAttach>(&mut methods);
    method::<CollaborationMembersDetach>(&mut methods);
    method::<CollaborationAssignmentsCreate>(&mut methods);
    method::<CollaborationAssignmentsGet>(&mut methods);
    method::<CollaborationAssignmentsList>(&mut methods);
    method::<CollaborationAssignmentsUpdate>(&mut methods);
    method::<CollaborationAssignmentsComplete>(&mut methods);
    method::<CollaborationAssignmentsCancel>(&mut methods);
    method::<CollaborationMessagesSend>(&mut methods);
    method::<CollaborationMessagesList>(&mut methods);
    method::<CollaborationContextPut>(&mut methods);
    method::<CollaborationContextList>(&mut methods);
    method::<CollaborationContextHistoryMethod>(&mut methods);
    method::<CollaborationWait>(&mut methods);
